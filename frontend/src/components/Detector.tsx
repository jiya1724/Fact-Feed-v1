...
// Define the types for the verification response
    ...
    <div className="min-h-screen bg-gradient-to-r from-purple-900 via-black to-blue-900 text-white">
      ...
      <main className="pt-40 w-full max-w-lg mx-auto px-4 bg-white bg-opacity-10 p-8 rounded-xl shadow-lg">
        ...
        <div className="mb-4">
          ...
          <textarea
            className="w-full p-2 rounded bg-black bg-opacity-30 focus:outline-none"
        ...
        <button
          ...
          className="w-full bg-purple-600 hover:bg-purple-700 py-2 rounded-xl transition transform hover:scale-105 hover:shadow-lg"
        >
