...
const SubmitNews = () => {
  ...
  const API_BASE_URL = "http://127.0.0.1:5000";  // Update if deployed online
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-purple-900 via-black to-blue-900 text-white">
      ...
      <main className="pt-40 w-full max-w-lg mx-auto px-4 bg-white bg-opacity-10 p-8 rounded-xl shadow-lg">
        ...
        <p className="text-center mb-6 text-gray-300">Check your news</p>
        ...
        <div className="flex justify-between space-x-4">
          ...
          <button onClick={handleSummarize} className="flex-1 bg-green-600 hover:bg-green-700 py-2 rounded-xl transition transform hover:scale-105 hover:shadow-lg">
